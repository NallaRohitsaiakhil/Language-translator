# pip3 uninstall googletrans and install the latest version of googletrans is pip3 instsll googletrans==3.1.0a0
from tkinter import *
...
root.resizable(0,0)
root.title("Project Rohit--Language Translator")
root.config(bg = 'ghost white')

Label(root, text = "LANGUAGE TRANSLATOR", font = "arial 20 bold", bg='white smoke').pack()
Label(root,text ="Project Rohit", font = 'arial 20 bold', bg ='white smoke' , width = '20').pack(side = 'bottom')
